    ...
    <div className="space-y-3">
      ...
      {selAgent && !act && (
        <div className="card p-4 space-y-3">
          ...
          <AgentPanel agent={selAgent} data={floor.perAgent[selAgent.id]} weight={floor.weights?.[selAgent.id]} calibration={floor.calibration?.[selAgent.id]} onAnalyze={onAnalyze} />
